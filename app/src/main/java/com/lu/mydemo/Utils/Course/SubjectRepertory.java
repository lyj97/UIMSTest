...
//        if(CourseJSONTransfer.transferCourseList(com.lu.mydemo.UIMS.getCourseJSON())){
//            return CourseJSONTransfer.courseList;
//        }

        return null;
    }

    public static List<MySubject> loadDefaultSubjects(Context context){
        if(CourseJSONTransfer.transferCourseList(context, UIMS.getCourseJSON())){
            return CourseJSONTransfer.courseList;
        }
        return null;
    }
